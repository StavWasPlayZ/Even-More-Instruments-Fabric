...
public class RecordCloningRecipe extends CustomRecipe {
    ...
    private static boolean isWritableRecord(final ItemStack stack) {
        return stack.is(ModItems.RECORD_WRITABLE) && !((WritableRecordItem)stack.getItem()).isBurned(stack);
    }
    ...
    public ItemStack assemble(CraftingContainer pContainer) {
        ...
        final ItemStack result = new ItemStack(ModItems.RECORD_WRITABLE);
    ...
    public RecipeSerializer<?> getSerializer() {
        return ModRecipeSerializers.RECORD_CLONING;
    }
